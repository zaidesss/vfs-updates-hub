...
export function DemoTour({ steps, isOpen, onClose, onComplete, userEmail }: DemoTourProps) {
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      console.error('Failed to mark demo as seen:', error);
    }
