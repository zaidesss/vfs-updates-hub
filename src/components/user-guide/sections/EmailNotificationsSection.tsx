    ...
    <GuideSection letter="AA" color="bg-pink-500" title="Email Notifications">
      ...
      <QuickTable 
        ...
        rows={[
          ...
          ['Leave Request Submitted', 'HR', 'Request details and link.'],
          ['Leave Request Decision', 'Submitter', 'Approved/Declined with remarks.'],
          ['Override Request', 'Admins', 'Conflict details and override reason.'],
